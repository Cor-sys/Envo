    ...
    <div className="space-y-2">
      ...
      {preview ? (
        ...
        <button
          ...
          disabled={busy}
          className="w-full h-40 rounded-xl border-2 border-dashed border-slate-700 bg-slate-900/40 text-slate-400 hover:border-honey-500/60 hover:text-honey-300 hover:bg-slate-900/60 transition-colors flex flex-col items-center justify-center gap-2"
        >
